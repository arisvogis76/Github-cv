require('dotenv').config(); // Προσθέτουμε την κλήση για το .env στην κορυφή

const express = require('express');
const sql = require('mssql');
const path = require('path');
const app = express();
// Παίρνει τη θύρα από το .env, αλλιώς τρέχει στην 3000
const port = process.env.PORT || 3000; 

// ==========================================
// 1. Ρυθμίσεις σύνδεσης με τον SQL Server Express
// ==========================================
const dbConfig = {
